...
class Dish {
    ...
    public String getFlavorProfile() { return flavor_profile; }
    public NutritionFacts getNutritionFacts() { return nutrition_facts; }
...
// cd "c:\Users\adity\OneDrive\Desktop\project\" ; if ($?) { javac -cp gson-2.10.1.jar Main.java } ; if ($?) { java -cp ".;gson-2.10.1.jar" Main $DishID }
